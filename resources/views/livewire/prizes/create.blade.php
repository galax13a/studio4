    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Create New Prize</h5>
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="date2" type="text" class="form-control" id="date2" placeholder="Date2">@error('date2') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
