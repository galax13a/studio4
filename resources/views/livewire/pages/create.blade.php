        ...
        <div class="modal-content">
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="moneda" type="text" class="form-control" id="moneda" placeholder="Moneda">@error('moneda') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="pagemaster_id"></label>
                <input wire:model="pagemaster_id" type="text" class="form-control" id="pagemaster_id" placeholder="Pagemaster Id">@error('pagemaster_id') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
