    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Create New Contable</h5>
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                <label for="codemaster"></label>
                <input wire:model="codemaster" type="text" class="form-control" id="codemaster" placeholder="Codemaster">@error('codemaster') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
